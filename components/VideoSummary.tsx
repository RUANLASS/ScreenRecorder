...
export default function VideoSummary({ playbackId }: { playbackId: string }) {
    ...
    const handleGenerate = async () => {
        ...
        // generateVideoSummary may have a void return in some builds; cast via unknown first
        const result = (await generateVideoSummary(playbackId)) as unknown as SummaryData | null;
